...
[[[LAWS]]]
列出本題答案所引用的所有法條，格式如下，每條佔一個區塊：

【法條名稱 第X條（第X項）】
條文全文：「…」（必須逐字摘錄自上方課程資料中出現的原文；若課程資料未載錄全文，則寫「課程資料未載全文，請查核全國法規資料庫」）
說明：本條在本題中的作用（一句話）

重要規則：
- 三種格式及法條列表必須引用完全相同的法條
- 所有法條條號必須在上方課程資料中明確出現，課程外的法條一概不得引用
- 條文全文只能逐字引用課程資料中的原文；課程資料未載全文者，寫「課程資料未載全文，請查核全國法規資料庫」，絕對禁止憑訓練記憶補充
